...
- natsuko
- 翌年の予測EPSだけではなく、これまでの収益率の推移状況を加味しないと購入銘柄を正しく判断することはできない
- 対数グラフは四半期ごとのEPSの増減率を明確に読み取るのに必要不可欠
  - 株価やEPSの対数グラフの目盛りは、どこを切り取っても等しい変化率を示しているため
  - 一般的な等差グラフのチャートは、株価が10ドルから20ドルへ100％上昇しても20ドルから30ドルへと50％上昇した時と目盛りが同じになってしまう
- 直近四半期のEPSとそれ以前の3四半期のEPSをすべて対数グラフに描画すると、EPSの増減がはっきりと見えるはず
  - 優秀な企業であれば、過去12ヶ月のEPSを四半期ごとに描いていくと、その線が最高値かそれに近い水準になるはず
